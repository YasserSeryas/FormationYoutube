...
export interface ApiFormationFormation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    acheteurs: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiModuleModule extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Module d'une formation";
    displayName: 'Module';
    pluralName: 'modules';
    singularName: 'module';
  };
...
export interface ApiProgressionProgression extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Suivi de la progression de l'utilisateur sur les vid\u00E9os";
  ...
  attributes: {
    completee: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_derniere_vue: Schema.Attribute.DateTime;
    derniere_position: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    pourcentage_visionne: Schema.Attribute.Integer &
...
export interface ApiVideoVideo extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Videos des modules de formation';
    displayName: 'Video';
    pluralName: 'videos';
    singularName: 'video';
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    formations_achetees: Schema.Attribute.Relation<
      'manyToMany',
      'api::formation.formation'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
